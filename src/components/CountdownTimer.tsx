...
export function CountdownTimer({ nextRace }: CountdownTimerProps) {
  ...
  const raceDateTime = new Date(`${nextRace.date}T${nextRace.time}`);
  const localRaceTime = dateFnsTz.formatInTimeZone(raceDateTime, 'Asia/Singapore', 'EEEE, MMMM d, h:mm a');
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-3 text-gray-600">
                  ...
                  <div>
                    <div className="text-lg">{localRaceTime}</div>
                    <div className="text-sm">Singapore Time</div>
                  </div>
                </div>
            ...
            {nextRace.circuitInfo && (
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="text-xl font-bold">{parseFloat(nextRace.circuitInfo.length).toFixed(3)}</div>
